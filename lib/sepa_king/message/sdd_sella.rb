...
module SEPA
  class SddSella < Message
    ...
    def to_xml(schema_name=self.known_schemas.first)
      ...
      builder = Nokogiri::XML::Builder.new do |builder|
        builder.CBISDDReqLogMsg(xml_schema(schema_name)) do
  ...
  private
    ...
    def xml_schema(schema_name)
      { :xmlns                => "urn:CBI:xsd:CBISDDReqLogMsg.00.01.00",
        :'xmlns:xsi'          => 'http://www.w3.org/2001/XMLSchema-instance',
        :'xsi:schemaLocation' => "urn:CBI:xsd:CBISDDReqLogMsg.00.01.00 CBISDDReqLogMsg.00.01.00.xsd" }
    end
          ...
          builder.CdtrAgt do
            builder.FinInstnId do
              builder.ClrSysMmbId do 
                builder.MmbId(group[:account].abi)
              end
